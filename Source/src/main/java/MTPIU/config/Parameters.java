...
public class Parameters {
    ...
    private int minOcc; // ngưỡng xuất hiện tối thiểu của một pattern (điều kiện để loại bỏ triệt để những mẫu pattern chỉ xuất hiện 2 lần nhưng may mắn lọt vô top K)
